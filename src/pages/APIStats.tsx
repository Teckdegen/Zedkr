...
const APIStats = () => {
  ...
  return (
    <DashboardLayout>
      <Link to="/my-apis" className="text-sm text-muted-foreground hover:text-foreground transition-colors mb-6 inline-block">
        ← Back to My APIs
      </Link>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-muted-foreground border-b border-border/50">
                ...
                <th className="text-left py-3 px-2 font-medium text-xs uppercase tracking-wider">Endpoint</th>
